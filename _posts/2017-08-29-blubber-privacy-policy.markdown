...
<p>Dhruv Patel built the Blubber app as a free app. This SERVICE is provided by Dhruv Patel at no cost and is intended
    for use as is.</p>
...
<p>For a better experience while using our Service, I may require you to provide us with certain
    personally identifiable information, including but not limited to users name and location. 
...
<ul>
    ...
    <li>To assist us in analyzing how my Service is used.</li>
</ul>
<p>I want to inform users of this Service that these third parties have access to your Personal
    Information. The reason is to perform the tasks assigned to them on my behalf. However, they
